...
public class VehicleDatabase {
	...
	static {
		...
		try {
			...
			connection=DriverManager.getConnection("jdbc:h2:mem:testdb;LOCK_MODE=0;INIT=runscript from 'C:/Sangeetha/workspaces/VehicleIdentifier/VehicleDetails/src/main/resources/init.sql'", "sa", "");
